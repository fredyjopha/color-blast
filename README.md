...
Explosions en vague : Chaque suppression crée une vague de particules vibrante.
Combo x2 : Groupes de 25 cases ou plus doublent les points avec une double vague.
Power-up intelligent : Supprimez une couleur dominante via VideoAd pour gérer la grille.
...
Pixi.js : Rendu WebGL pour des performances fluides.
...
Joueurs occasionnels : Fans de match-3 comme Candy Crush ou 1010 Color Match (Poki, itch.io).
Joueurs mobiles : Interface tactile intuitive (App Store, Play Store).
Joueurs PC : Expérience soignée avec classements (Steam).
Systèmes embarqués : Léger et optimisé pour petits écrans.

💰 Monétisation

Publicités récompensées : Power-up via VideoAd (compatible avec le SDK Poki ou AdSense).
Pay-what-you-want : Sur itch.io, avec dons via Ko-fi/PayPal.
Achats in-app : Thèmes ou suppression des pubs (mobile).

📢 Marketing

Slogan : "Connectez les couleurs, déclenchez la vague !"
